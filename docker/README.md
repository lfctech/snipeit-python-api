...
To run the integration suite against another explicitly pinned Snipe-IT image
as an advisory compatibility check:

```bash
SNIPEIT_IMAGE=snipe/snipe-it:v8.7.1-alpine make test-integration
```
