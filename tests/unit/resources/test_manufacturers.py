...
def test_list_manufacturers(snipeit_client, httpx_mock):
    httpx_mock.add_response(method="GET", url="https://test.snipeitapp.com/api/v1/manufacturers", json={"total": 1, "rows": [{"id": 1, "name": "Test Manufacturer"}]})
...
def test_get_manufacturer(snipeit_client, httpx_mock):
    httpx_mock.add_response(method="GET", url="https://test.snipeitapp.com/api/v1/manufacturers/1", json={"id": 1, "name": "Test Manufacturer"})
...
def test_create_manufacturer(snipeit_client, httpx_mock):
    httpx_mock.add_response(method="POST", url="https://test.snipeitapp.com/api/v1/manufacturers", json={"status": "success", "payload": {"id": 2, "name": "New Manufacturer"}})
...
def test_patch_manufacturer(snipeit_client, httpx_mock):
    httpx_mock.add_response(method="PATCH", url="https://test.snipeitapp.com/api/v1/manufacturers/1", json={"status": "success", "payload": {"id": 1, "name": "Patched Manufacturer"}})
...
def test_delete_manufacturer(snipeit_client, httpx_mock):
    httpx_mock.add_response(method="DELETE", url="https://test.snipeitapp.com/api/v1/manufacturers/1", json={"status": "success", "messages": "Manufacturer deleted"})
    snipeit_client.manufacturers.delete(1)
    assert len(httpx_mock.get_requests()) == 1

def test_save_manufacturer(snipeit_client, httpx_mock):
    httpx_mock.add_response(method="GET", url="https://test.snipeitapp.com/api/v1/manufacturers/1", json={"id": 1, "name": "Test Manufacturer"})
    httpx_mock.add_response(method="PATCH", url="https://test.snipeitapp.com/api/v1/manufacturers/1", json={"status": "success", "payload": {"id": 1, "name": "Saved Manufacturer"}})
    manufacturer = snipeit_client.manufacturers.get(1)
